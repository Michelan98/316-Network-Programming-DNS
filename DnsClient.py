...
# # if server_address != (args.server[1:], args.p):
# # 	print('ERROR	Response from the wrong server')
# # 	exit()
# if response[3] & 1:
# 	print('ERROR	DNS server unable to interpret the query')
# 	exit()
# elif response[3] & 2:
# 	print('ERROR	DNS server was unable to process this query due to a problem with the name server')
# 	exit()
# elif response[3] & 3:
# 	print('ERROR	Domain name referenced in the query does not exist.')
# 	exit()
# elif response[3] & 4:
# 	print('ERROR	DNS server does not support the requested kind of query')
# 	exit()
...
for i in range(answer_count):
    ...
    if type == 'A':
        ...
        print(type + "    " + IP_Address + "    " + str(TTL) + "   " + auth + '\n')
